...
// estructura de los datos del vampiro
public struct DatosVampire
{
	public Color col; //color del vampiro
}
...
public struct datosciudadano                                              
{
	...
	static public explicit operator Zonbiedates(datosciudadano c)
    {
		return new Zonbiedates();
    }
}
